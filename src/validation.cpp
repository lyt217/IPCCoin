...
#if defined(NDEBUG)
# error "IPCcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "IPCcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s IPC additional fees, %d delta bytes\n",
