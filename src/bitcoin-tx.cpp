...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ipccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ipccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ipccoin transaction") + "\n" +
              "  ipccoin-tx [options] -create [commands]   " + _("Create hex-encoded ipccoin transaction") + "\n" +
              "\n";
