...
const char * const BITCOIN_CONF_FILENAME = "ipccoin.conf";
const char * const BITCOIN_PID_FILENAME = "ipccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "IPCcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/IPCcoin";
#else
    // Unix
    return pathRet / ".ipccoin";
#endif
#endif
}
